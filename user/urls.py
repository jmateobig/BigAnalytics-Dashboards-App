...
from .views import  ProfileView, ProfileEditView, UserListView, UserCreateView, UserEditView, UserListJsonView, UserDetailJsonView, UserToggleStatusView, UserDeleteView
